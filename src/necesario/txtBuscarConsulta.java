 ...
 * Urieta Camacho
 */
public class txtBuscarConsulta
        extends JTextField
    ...
    public txtBuscarConsulta() {
        ...
        getDocument().addDocumentListener(new DocumentListener() {
            public void removeUpdate(DocumentEvent e) {
                txtBuscarConsulta.this.band = (txtBuscarConsulta.this.getText().length() <= 0);
            }

            public void insertUpdate(DocumentEvent e) {
                txtBuscarConsulta.this.band = false;
            }
        ...
        this.button.addMouseListener(new MouseListener() {
            public void mouseClicked(MouseEvent e) {
                ((JTextField) txtBuscarConsulta.this.button.getParent()).setText("");
                ((JTextField) txtBuscarConsulta.this.button.getParent()).requestFocus();
            ...
            public void mouseEntered(MouseEvent e) {
                txtBuscarConsulta.this.button.setOpaque(true);
                txtBuscarConsulta.this.button.setIcon(txtBuscarConsulta.this.xBlackIcon ? txtBuscarConsulta.this.iconBlack : txtBuscarConsulta.this.iconWhite);
            }

            public void mouseExited(MouseEvent e) {
                txtBuscarConsulta.this.button.setOpaque(false);
                txtBuscarConsulta.this.button.setIcon(null);
            }
        });
