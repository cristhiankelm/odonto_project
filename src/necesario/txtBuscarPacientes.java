...
/**
 *
 * @author RojeruSan Sigueme en https://www.youtube.com/c/RojeruSan Rogelio
 * Urieta Camacho
 */
public class txtBuscarPacientes
        extends JTextField
    ...
    public txtBuscarPacientes() {
        ...
        getDocument().addDocumentListener(new DocumentListener() {
            public void removeUpdate(DocumentEvent e) {
                txtBuscarPacientes.this.band = (txtBuscarPacientes.this.getText().length() <= 0);
            }

            public void insertUpdate(DocumentEvent e) {
                txtBuscarPacientes.this.band = false;
            }
        ...
        this.button.addMouseListener(new MouseListener() {
            public void mouseClicked(MouseEvent e) {
                ((JTextField) txtBuscarPacientes.this.button.getParent()).setText("");
                ((JTextField) txtBuscarPacientes.this.button.getParent()).requestFocus();
            ...
            public void mouseEntered(MouseEvent e) {
                txtBuscarPacientes.this.button.setOpaque(true);
                txtBuscarPacientes.this.button.setIcon(txtBuscarPacientes.this.xBlackIcon ? txtBuscarPacientes.this.iconBlack : txtBuscarPacientes.this.iconWhite);
            }

            public void mouseExited(MouseEvent e) {
                txtBuscarPacientes.this.button.setOpaque(false);
                txtBuscarPacientes.this.button.setIcon(null);
            }
        });
