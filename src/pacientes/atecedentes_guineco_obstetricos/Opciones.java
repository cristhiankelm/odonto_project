...
public class Opciones {
    ...
    public static boolean registrar(Sentencias uc) {
        ...
        try {
            ...
            ps.setString(2, uc.getMenarca());
            ps.setString(3, uc.getIvsa());
            ps.setInt(4, uc.getNumero_parejas());
            ps.setInt(5, uc.getEmbarazos());
            ps.setString(6, uc.getMetodo_anticonceptivo());
            ps.executeUpdate();
            return true;
    ...
    public static boolean actualizar(Sentencias uc) {
        ...
        try {
            ps = cn.prepareStatement(sql);
            ps.setString(1, uc.getMenarca());
            ps.setString(2, uc.getIvsa());
            ps.setInt(3, uc.getNumero_parejas());
            ps.setInt(4, uc.getEmbarazos());
            ps.setString(5, uc.getMetodo_anticonceptivo());
