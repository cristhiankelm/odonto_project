...
public class Registrar extends javax.swing.JDialog {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        //Hora del sistema
        Timer tiempo = new Timer(100, new Registrar.hora());
        tiempo.start();
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (this.txtNumControl.getText().length() != 0) {
                if (Opciones.verificaNumControl(this.txtNumControl.getText())) {
                    ...
                    a.msj1.setText("El No. CONTROL ingresado");
                    a.msj2.setText("no existe.");
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        if (this.txtNumControl.getText().length() == 0 || this.txtDescripcion.getText().length() == 0
            ...
            s.setHora(this.lblHora.getText());

            if (Opciones.registrar(s)) {

                Opciones.listar("");
                Opciones.selecionaFila(this.lblID.getText());

                this.dispose();

                SuccessAlert a = new SuccessAlert(null, true);
                a.msj1.setText("Consulta registrada con exito.");
                a.msj2.setVisible(false);
                a.msj3.setVisible(false);
                a.setVisible(true);

                principal.Principal.id_consulta = this.lblID.getText();
                new consultas.VerDatos(null, true).setVisible(true);
            }
        }
